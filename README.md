...
3. Log in and create bookmarks from the bookmarklet (see [Using the Bookmarklet](#using-the-bookmarklet)), or import bookmarks from the settings -> Import / Export page
