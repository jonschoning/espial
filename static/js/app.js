      ...
      var onEvent = function (v) {
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.BMark line 229, column 18 - line 235, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.BMark line 191, column 3 - line 191, column 65: " + [ v.constructor.name ]);
      };
      var mkState = function (b) {
          return {
              bm: b,
...
(function(exports) {
  ...
  var nnote = function (st$prime) {
      ...
      var renderNote = function (st) {
          return function (bm) {
              var mmoment = Globals.mmoment8601(bm.created);
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showInt)(bm.id)), Util.class_("note w-100 mw7 pa1 mb2") ])([ Halogen_HTML_Elements.div([ Util.class_("display") ])([ Halogen_HTML_Elements.div([ Util.class_("link f5 lh-title") ])([ Halogen_HTML_Core.text((function () {
                  var $2 = Data_String_Common["null"](bm.title);
                  if ($2) {
                      return "[no title]";
                  };
                  return bm.title;
              })()) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Util.class_("description mt1 mid-gray") ])(toTextarea(bm.text)), Halogen_HTML_Elements.div([ Util.class_("link f7 dib gray w4"), Halogen_HTML_Properties.title(Data_Maybe.maybe(bm.created)(Data_Tuple.snd)(mmoment)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]) ]) ]);
          };
      };
      var render = function (st) {
          return renderNote(st)(st.note);
      };
      ...
      var renderNote = function (st) {
          return function (bm) {
              ...
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showInt)(bm.id)), Util.class_("note w-100 mw7 pa1 mb2") ])([ Halogen_HTML_Elements.div([ Util.class_("display") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(linkToFilterSingle(bm.id)), Halogen_HTML_Properties.target("_blank"), Util.class_("link f5 lh-title") ])([ Halogen_HTML_Core.text((function () {
                  var $7 = Data_String_Common["null"](bm.title);
                  if ($7) {
                      return "[no title]";
                  };
                  return bm.title;
              })()) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Util.class_("description mt1 mid-gray") ])(toTextarea(Data_String_CodePoints.take(200)(bm.text))), Halogen_HTML_Elements.a([ Util.class_("link f7 dib gray w4"), Halogen_HTML_Properties.title(Data_Maybe.maybe(bm.created)(Data_Tuple.snd)(mmoment)), Halogen_HTML_Properties.href(linkToFilterSingle(bm.id)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]) ]) ]);
          };
      };
      var render = function (st) {
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderNote(st))(st.notes));
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](mkState(st$prime)),
          render: render,
