      ...
      var $$eval = function (v) {
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.Add line 154, column 18 - line 160, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.Add line 144, column 3 - line 144, column 58: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.BMark line 212, column 18 - line 218, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.BMark line 188, column 3 - line 188, column 62: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
      var render = function (v) {
          var toTextarea = function ($82) {
              return Data_Array.drop(1)(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidArray)(function (x) {
                  return [ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(x) ];
              })(Data_String_Common.split("\x0a")($82)));
          };
