...
(function(exports) {
  ...
  var wfI = Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "bid";
...
(function(exports) {
  ...
  var editBookmark = function (bm) {
      return fetchJson(Model.wfI)(Data_HTTP_Method.POST.value)("api/add")(Data_Maybe.Just.create(bm))(Network_HTTP_Affjax_Response.ignore);
  };
  ...
  var addbmark = function (b$prime) {
      var render = function (v) {
          var toTextarea = function ($97) {
              ...
              })(Data_String_Common.split("\x0a")($97)));
          };
          var mmoment = Globals.mmoment8601(v.bm.time);
          var exists = Halogen_HTML_Elements.div([ Util.class_("alert") ])([ Halogen_HTML_Core.text("previously saved\xa0"), Halogen_HTML_Elements.span([ Util.class_("when js-moment"), Halogen_HTML_Properties.title(Data_Maybe.maybe(v.bm.time)(Data_Tuple.snd)(mmoment)), Util.attr("data-iso8601")(v.bm.time) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]), Halogen_HTML_Elements.div([ Util.class_("edit_links"), Util.attr("style")("display: inline-block; margin-left: 5px;") ])([ Halogen_HTML_Elements.div([ Util.class_("delete_link") ])([ Halogen_HTML_Elements.button(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDeleteAsk.create(true))), Util.class_("delete") ])(Data_Monoid.guard(Data_Monoid.monoidArray)(v.deleteAsk)([ Util.attr("hidden")("hidden") ])))([ Halogen_HTML_Core.text("delete") ]), Halogen_HTML_Elements.span(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Util.class_("confirm") ])(Data_Monoid.guard(Data_Monoid.monoidArray)(!v.deleteAsk)([ Util.attr("hidden")("hidden") ])))([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDeleteAsk.create(false))) ])([ Halogen_HTML_Core.text("cancel\xa0/\xa0") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDestroy.create)), Util.class_("destroy") ])([ Halogen_HTML_Core.text("destroy") ]) ]) ]) ]) ]);
          var display_edit = Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(BEditSubmit.create)) ])([ Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.tbody_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([  ]), Halogen_HTML_Elements.td_(Data_Monoid.guard(Data_Monoid.monoidArray)(v.bm.bid > 0)([ exists ])) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("url") ])([ Halogen_HTML_Core.text("URL") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputUrl.value), Halogen_HTML_Properties.id_("url"), Util.class_("url"), Halogen_HTML_Properties.required(true), Halogen_HTML_Properties.name("url"), Util.attr("size")("70"), Halogen_HTML_Properties.value(v.edit_bm.url), Halogen_HTML_Events.onValueChange(function ($98) {
              return Halogen_HTML_Events.input(BEditField.create)(Eurl.create($98));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("title") ])([ Halogen_HTML_Core.text("title") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_("title"), Util.class_("title"), Halogen_HTML_Properties.name("title"), Util.attr("size")("70"), Halogen_HTML_Properties.value(v.edit_bm.title), Halogen_HTML_Events.onValueChange(function ($99) {
              return Halogen_HTML_Events.input(BEditField.create)(Etitle.create($99));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("description") ])([ Halogen_HTML_Core.text("description") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.textarea([ Util.class_("description"), Halogen_HTML_Properties.id_("description"), Halogen_HTML_Properties.name("description"), Util.attr("cols")("70"), Halogen_HTML_Properties.rows(4), Halogen_HTML_Properties.value(v.edit_bm.description), Halogen_HTML_Events.onValueChange(function ($100) {
              return Halogen_HTML_Events.input(BEditField.create)(Edescription.create($100));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("tags") ])([ Halogen_HTML_Core.text("tags") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_("tags"), Util.class_("tags"), Halogen_HTML_Properties.name("tags"), Util.attr("size")("70"), Halogen_HTML_Properties.autocomplete(false), Util.attr("autocapitalize")("off"), Halogen_HTML_Properties.value(v.edit_bm.tags), Halogen_HTML_Events.onValueChange(function ($101) {
              return Halogen_HTML_Events.input(BEditField.create)(Etags.create($101));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("private") ])([ Halogen_HTML_Core.text("private") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.id_("private"), Util.class_("private"), Halogen_HTML_Properties.name("private"), Halogen_HTML_Properties.checked(v["edit_bm"]["private"]), Halogen_HTML_Events.onChecked(function ($102) {
              return Halogen_HTML_Events.input(BEditField.create)(Eprivate.create($102));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("toread") ])([ Halogen_HTML_Core.text("read later") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.id_("toread"), Util.class_("toread"), Halogen_HTML_Properties.name("toread"), Halogen_HTML_Properties.checked(v.edit_bm.toread), Halogen_HTML_Events.onChecked(function ($103) {
              return Halogen_HTML_Events.input(BEditField.create)(Etoread.create($103));
          }) ]) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([  ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Util.class_("submit"), Halogen_HTML_Properties.value((function () {
              var $27 = v.bm.bid > 0;
              if ($27) {
          ...
          return Halogen_HTML_Elements.div_([ display_edit ]);
      };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.destroy(v1))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Util._loc))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Util._curQuerystring))(function (v3) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Eurl) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $45.edit_bm = (function () {
                                  var $42 = {};
                                  for (var $43 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $43)) {
                                          $42[$43] = v1["edit_bm"][$43];
                                      };
                                  };
                                  $42.url = v.value0.value0;
                                  return $42;
                              })();
                              return $45;
                          })());
                      ...
                      if (v.value0 instanceof Etitle) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $52.edit_bm = (function () {
                                  var $49 = {};
                                  for (var $50 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $50)) {
                                          $49[$50] = v1["edit_bm"][$50];
                                      };
                                  };
                                  $49.title = v.value0.value0;
                                  return $49;
                              })();
                              return $52;
                          })());
                      ...
                      if (v.value0 instanceof Edescription) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $59.edit_bm = (function () {
                                  var $56 = {};
                                  for (var $57 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $57)) {
                                          $56[$57] = v1["edit_bm"][$57];
                                      };
                                  };
                                  $56.description = v.value0.value0;
                                  return $56;
                              })();
                              return $59;
                          })());
                      ...
                      if (v.value0 instanceof Etags) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $66.edit_bm = (function () {
                                  var $63 = {};
                                  for (var $64 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $64)) {
                                          $63[$64] = v1["edit_bm"][$64];
                                      };
                                  };
                                  $63.tags = v.value0.value0;
                                  return $63;
                              })();
                              return $66;
                          })());
                      ...
                      if (v.value0 instanceof Eprivate) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $73.edit_bm = (function () {
                                  var $70 = {};
                                  for (var $71 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $71)) {
                                          $70[$71] = v1["edit_bm"][$71];
                                      };
                                  };
                                  $70["private"] = v.value0.value0;
                                  return $70;
                              })();
                              return $73;
                          })());
                      ...
                      if (v.value0 instanceof Etoread) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $80.edit_bm = (function () {
                                  var $77 = {};
                                  for (var $78 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $78)) {
                                          $77[$78] = v1["edit_bm"][$78];
                                      };
                                  };
                                  $77.toread = v.value0.value0;
                                  return $77;
                              })();
                              return $80;
                          })());
                      };
                      throw new Error("Failed pattern match at Component.Add line 158, column 5 - line 164, column 68: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
...
(function(exports) {
  ...
  var bmark = function (b$prime) {
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.toggleStar(v1.bm.bid)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $38.bm = (function () {
                              var $32 = {};
                              for (var $33 in v1.bm) {
                                  if ({}.hasOwnProperty.call(v1.bm, $33)) {
                                      $32[$33] = v1["bm"][$33];
                                  };
                              };
                              $32.selected = v.value0;
                              return $32;
                          })();
                          $38.edit_bm = (function () {
                              var $35 = {};
                              for (var $36 in v1.edit_bm) {
                                  if ({}.hasOwnProperty.call(v1.edit_bm, $36)) {
                                      $35[$36] = v1["edit_bm"][$36];
                                  };
                              };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.markRead(v1.bm.bid))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $54.bm = (function () {
                              var $51 = {};
                              for (var $52 in v1.bm) {
                                  if ({}.hasOwnProperty.call(v1.bm, $52)) {
                                      $51[$52] = v1["bm"][$52];
                                  };
                              };
                              $51.toread = false;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Eurl) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $69.edit_bm = (function () {
                                  var $66 = {};
                                  for (var $67 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $67)) {
                                          $66[$67] = v1["edit_bm"][$67];
                                      };
                                  };
                                  $66.url = v.value0.value0;
                                  return $66;
                              })();
                              return $69;
                          })());
                      ...
                      if (v.value0 instanceof Etitle) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $76.edit_bm = (function () {
                                  var $73 = {};
                                  for (var $74 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $74)) {
                                          $73[$74] = v1["edit_bm"][$74];
                                      };
                                  };
                                  $73.title = v.value0.value0;
                                  return $73;
                              })();
                              return $76;
                          })());
                      ...
                      if (v.value0 instanceof Edescription) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $83.edit_bm = (function () {
                                  var $80 = {};
                                  for (var $81 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $81)) {
                                          $80[$81] = v1["edit_bm"][$81];
                                      };
                                  };
                                  $80.description = v.value0.value0;
                                  return $80;
                              })();
                              return $83;
                          })());
                      ...
                      if (v.value0 instanceof Etags) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $90.edit_bm = (function () {
                                  var $87 = {};
                                  for (var $88 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $88)) {
                                          $87[$88] = v1["edit_bm"][$88];
                                      };
                                  };
                                  $87.tags = v.value0.value0;
                                  return $87;
                              })();
                              return $90;
                          })());
                      ...
                      if (v.value0 instanceof Eprivate) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $97.edit_bm = (function () {
                                  var $94 = {};
                                  for (var $95 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $95)) {
                                          $94[$95] = v1["edit_bm"][$95];
                                      };
                                  };
                                  $94["private"] = v.value0.value0;
                                  return $94;
                              })();
                              return $97;
                          })());
                      ...
                      if (v.value0 instanceof Etoread) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $104.edit_bm = (function () {
                                  var $101 = {};
                                  for (var $102 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $102)) {
                                          $101[$102] = v1["edit_bm"][$102];
                                      };
                                  };
                                  $101.toread = v.value0.value0;
                                  return $101;
                              })();
                              return $104;
                          })());
                      };
                      throw new Error("Failed pattern match at Component.BMark line 212, column 5 - line 218, column 68: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Component.BMark line 187, column 3 - line 187, column 62: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
      var render = function (v) {
          var toTextarea = function ($121) {
              return Data_Array.drop(1)(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidArray)(function (x) {
                  return [ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(x) ];
              })(Data_String_Common.split("\x0a")($121)));
          };
          var star = Data_Monoid.guard(Data_Monoid.monoidArray)(app.dat.isowner)([ Halogen_HTML_Elements.div([ Util.class_("star" + Data_Monoid.guard(Data_Monoid.monoidString)(v.bm.selected)(" selected_star")) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BStar.create(!v.bm.selected))) ])([ Halogen_HTML_Core.text("\u272d") ]) ]) ]);
          var mmoment = Globals.mmoment8601(v.bm.time);
          var links = Data_Monoid.guard(Data_Monoid.monoidArray)(app.dat.isowner)([ Halogen_HTML_Elements.div([ Util.class_("edit_links") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BEdit.create(true))), Util.class_("edit") ])([ Halogen_HTML_Core.text("edit\xa0\xa0") ]), Halogen_HTML_Elements.div([ Util.class_("delete_link") ])([ Halogen_HTML_Elements.button(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDeleteAsk.create(true))), Util.class_("delete") ])(Data_Monoid.guard(Data_Monoid.monoidArray)(v.deleteAsk)([ Util.attr("hidden")("hidden") ])))([ Halogen_HTML_Core.text("delete") ]), Halogen_HTML_Elements.span(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Util.class_("confirm") ])(Data_Monoid.guard(Data_Monoid.monoidArray)(!v.deleteAsk)([ Util.attr("hidden")("hidden") ])))([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDeleteAsk.create(false))) ])([ Halogen_HTML_Core.text("cancel\xa0/\xa0") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BDestroy.create)), Util.class_("destroy") ])([ Halogen_HTML_Core.text("destroy") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Util.class_("read") ])(Data_Monoid.guard(Data_Monoid.monoidArray)(v.bm.toread)([ Halogen_HTML_Core.text("\xa0\xa0"), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BMarkRead.create)), Util.class_("mark_read") ])([ Halogen_HTML_Core.text("mark as read") ]) ])) ]);
          ...
          var display_edit = [ Halogen_HTML_Elements.div([ Util.class_("edit_bookmark_form active") ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(BEditSubmit.create)) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputUrl.value), Util.class_("url edit_form_input"), Halogen_HTML_Properties.required(true), Halogen_HTML_Properties.name("url"), Halogen_HTML_Properties.value(v.edit_bm.url), Halogen_HTML_Events.onValueChange(function ($122) {
              return Halogen_HTML_Events.input(BEditField.create)(Eurl.create($122));
          }) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Util.class_("title edit_form_input"), Halogen_HTML_Properties.name("title"), Halogen_HTML_Properties.value(v.edit_bm.title), Halogen_HTML_Events.onValueChange(function ($123) {
              return Halogen_HTML_Events.input(BEditField.create)(Etitle.create($123));
          }) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.p([ Util.attr("style")("margin-top:10px;margin-bottom:5px;") ])([ Halogen_HTML_Core.text(" description:") ]), Halogen_HTML_Elements.textarea([ Util.class_("description edit_form_input"), Halogen_HTML_Properties.name("description"), Halogen_HTML_Properties.rows(5), Halogen_HTML_Properties.value(v.edit_bm.description), Halogen_HTML_Events.onValueChange(function ($124) {
              return Halogen_HTML_Events.input(BEditField.create)(Edescription.create($124));
          }) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("tags_input_box") ])([ Halogen_HTML_Elements.p([ Util.attr("style")("margin-top:10px") ])([ Halogen_HTML_Core.text(" tags:"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Util.class_("tags edit_form_input"), Halogen_HTML_Properties.name("tags"), Halogen_HTML_Properties.autocomplete(false), Util.attr("autocapitalize")("off"), Halogen_HTML_Properties.value(v.edit_bm.tags), Halogen_HTML_Events.onValueChange(function ($125) {
              return Halogen_HTML_Events.input(BEditField.create)(Etags.create($125));
          }) ]), Halogen_HTML_Elements.br_ ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("edit_form_checkboxes") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Util.class_("private"), Halogen_HTML_Properties.id_("edit_private"), Halogen_HTML_Properties.name("private"), Halogen_HTML_Properties.checked(v["edit_bm"]["private"]), Halogen_HTML_Events.onChecked(function ($126) {
              return Halogen_HTML_Events.input(BEditField.create)(Eprivate.create($126));
          }) ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("edit_private") ])([ Halogen_HTML_Core.text("private") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Util.class_("toread"), Halogen_HTML_Properties.id_("edit_toread"), Halogen_HTML_Properties.name("toread"), Halogen_HTML_Properties.checked(v.edit_bm.toread), Halogen_HTML_Events.onChecked(function ($127) {
              return Halogen_HTML_Events.input(BEditField.create)(Etoread.create($127));
          }) ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("edit_toread") ])([ Halogen_HTML_Core.text("toread") ]), Halogen_HTML_Elements.br_ ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Util.class_("submit edit-button"), Halogen_HTML_Properties.value("save") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputReset.value), Util.class_("reset edit-button"), Halogen_HTML_Properties.value("cancel"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BEdit.create(false))) ]) ]) ]) ];
          var display = [ Halogen_HTML_Elements.div([ Util.class_("display") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.bm.url), Halogen_HTML_Properties.target("_blank"), Util.class_("bookmark_title" + Data_Monoid.guard(Data_Monoid.monoidString)(v.bm.toread)(" unread")) ])([ Halogen_HTML_Core.text((function () {
              var $117 = Data_String_Common["null"](v.bm.title);
              if ($117) {
                  return "[no title]";
              };
              return v.bm.title;
          })()) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.bm.url), Util.class_("url_display") ])([ Halogen_HTML_Core.text(v.bm.url) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Util.class_("description") ])(toTextarea(v.bm.description)), Halogen_HTML_Elements.div([ Util.class_("tags") ])(Data_Monoid.guard(Data_Monoid.monoidFn(Data_Monoid.monoidFn(Data_Monoid.monoidArray)))(!Data_String_Common["null"](v.bm.tags))(Data_Functor.map(Data_Functor.functorArray))(function (tag) {
              return Halogen_HTML_Elements.a([ Util.class_("tag" + Data_Monoid.guard(Data_Monoid.monoidString)(Data_String_CodePoints.take(1)(tag) === ".")(" private")), Halogen_HTML_Properties.href(linkToFilterTag(tag)) ])([ Halogen_HTML_Core.text(tag) ]);
          })(Data_String_Common.split(" ")(v.bm.tags))), Halogen_HTML_Elements.a([ Util.class_("when js-moment"), Halogen_HTML_Properties.title(Data_Maybe.maybe(v.bm.time)(Data_Tuple.snd)(mmoment)), Util.attr("data-iso8601")(v.bm.time), Halogen_HTML_Properties.href(linkToFilterSingle(v.bm.bid)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]) ])(links)) ];
          var clearBoth = [ Halogen_HTML_Elements.div([ Util.attr("style")("clear:both") ])([  ]) ];
          var bookmark = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showInt)(v.bm.bid)), Util.class_("bookmark" + Data_Monoid.guard(Data_Monoid.monoidString)(v["bm"]["private"])(" private")) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(star)((function () {
              if (v.edit) {
                  return display_edit;
              };
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(display)(clearBoth);
          })()));
          return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ bookmark ])(clearBoth));
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](mkState(b$prime)),
          render: render,
...
(function(exports) {
  ...
  var toggleDelete = function (toggle) {
      return function (n) {
          return Data_Functor["void"](Effect.functorEffect)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Util._mt(Globals.closest(".delete_link")(n)))(function (v) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Util._mt(Util._querySelector(".confirm")(Util._fromNode(v))))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Util._mt(Util._querySelector(".delete")(Util._fromNode(v))))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Effect.monadEffect)(Web_DOM_Element.removeAttribute("hidden")((function () {
                          if (toggle) {
                              return v1;
                          };
                          return v2;
                      })())))(function () {
                          return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Effect.monadEffect)(Web_DOM_Element.setAttribute("hidden")("hidden")((function () {
                              var $15 = !toggle;
                              if ($15) {
                                  return v1;
                              };
  ...
  var replaceIsoTimestamps = function (u) {
      return function __do() {
          var v = Util._body();
          var v1 = Util._querySelectorAll(".js-moment")(Web_HTML_HTMLElement.toElement(v))();
          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(v1)(function (x) {
              return function __do() {
                  var s$prime = Globals.getDataAttribute("iso8601")(Util._fromNode(x))();
                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(s$prime)(function (s) {
                      return function __do() {
                          var v2 = Globals.moment8601(s)();
                          Web_DOM_Node.setTextContent(v2.value0)(x)();
                          Web_DOM_Element.setAttribute("title")(v2.value1)(Util._fromNode(x))();
                          return Web_DOM_Element.setAttribute("style")("visibility:visible")(Util._fromNode(x))();
                      };
                  })();
              };
          })();
      ...
      return function (bid) {
          return function (isPopup) {
              var removeBookmarkNode = function (v) {
                  return Data_Functor["void"](Effect.functorEffect)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Util._mt_pure(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_DOM_Node.fromEventTarget)(Web_Event_Event.target(e))))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Util._mt(Globals.closest(".bookmark")(v1)))(function (v2) {
                          return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Effect.monadEffect)(Web_DOM_ChildNode.remove(Web_DOM_Element.toChildNode(Util._fromNode(v2))));
                      });
                  })));
              };
              var removeBody = function (v) {
                  return function __do() {
                      var v1 = Util._body();
                      return Data_Functor["void"](Effect.functorEffect)(Globals.setInnerHtml("<p class='error'>you killed this bookmark</p>")(v1))();
                  };
              };
              return function __do() {
                  Web_Event_Event.preventDefault(e)();
                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(App.destroy(bid)))(function () {
  ...
  var deleteCancelE = function (e) {
      return function __do() {
          Web_Event_Event.preventDefault(e)();
          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(toggleDelete(false))(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_DOM_Node.fromEventTarget)(Web_Event_Event.target(e)))();
      };
  };
  var deleteAskE = function (e) {
      return function __do() {
          Web_Event_Event.preventDefault(e)();
          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(toggleDelete(true))(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_DOM_Node.fromEventTarget)(Web_Event_Event.target(e)))();
      };
  };
