...
(function(exports) {
  ...
  var addbmark = function (b$prime) {
      var render = function (v) {
          ...
          var display_destroyed = Halogen_HTML_Elements.p([ Util.class_("error") ])([ Halogen_HTML_Core.text("you killed this bookmark") ]);
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Eurl) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $46.edit_bm = (function () {
                                  var $43 = {};
                                  for (var $44 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $44)) {
                                          $43[$44] = v1["edit_bm"][$44];
                                      };
                                  };
                                  $43.url = v.value0.value0;
                                  return $43;
                              })();
                              return $46;
                          })());
                      ...
                      if (v.value0 instanceof Etitle) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $53.edit_bm = (function () {
                                  var $50 = {};
                                  for (var $51 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $51)) {
                                          $50[$51] = v1["edit_bm"][$51];
                                      };
                                  };
                                  $50.title = v.value0.value0;
                                  return $50;
                              })();
                              return $53;
                          })());
                      ...
                      if (v.value0 instanceof Edescription) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $60.edit_bm = (function () {
                                  var $57 = {};
                                  for (var $58 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $58)) {
                                          $57[$58] = v1["edit_bm"][$58];
                                      };
                                  };
                                  $57.description = v.value0.value0;
                                  return $57;
                              })();
                              return $60;
                          })());
                      ...
                      if (v.value0 instanceof Etags) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $67.edit_bm = (function () {
                                  var $64 = {};
                                  for (var $65 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $65)) {
                                          $64[$65] = v1["edit_bm"][$65];
                                      };
                                  };
                                  $64.tags = v.value0.value0;
                                  return $64;
                              })();
                              return $67;
                          })());
                      ...
                      if (v.value0 instanceof Eprivate) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $74.edit_bm = (function () {
                                  var $71 = {};
                                  for (var $72 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $72)) {
                                          $71[$72] = v1["edit_bm"][$72];
                                      };
                                  };
                                  $71["private"] = v.value0.value0;
                                  return $71;
                              })();
                              return $74;
                          })());
                      ...
                      if (v.value0 instanceof Etoread) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $81.edit_bm = (function () {
                                  var $78 = {};
                                  for (var $79 in v1.edit_bm) {
                                      if ({}.hasOwnProperty.call(v1.edit_bm, $79)) {
                                          $78[$79] = v1["edit_bm"][$79];
                                      };
                                  };
                                  $78.toread = v.value0.value0;
                                  return $78;
                              })();
                              return $81;
                          })());
                      };
                      throw new Error("Failed pattern match at Component.Add line 153, column 5 - line 159, column 68: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Component.Add line 142, column 3 - line 142, column 58: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
