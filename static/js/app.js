      ...
      var $$eval = function (v) {
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.BMark line 210, column 18 - line 216, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.BMark line 186, column 3 - line 186, column 62: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
      var render = function (v) {
          ...
          })(Data_String_Common.split(" ")(v.bm.tags))), Halogen_HTML_Elements.a([ Util.class_("when"), Halogen_HTML_Properties.title(Data_Maybe.maybe(v.bm.time)(Data_Tuple.snd)(mmoment)), Halogen_HTML_Properties.href(linkToFilterSingle(v.bm.bid)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]) ])(links)) ];
